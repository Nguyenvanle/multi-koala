...
import { CourseTypeResType, CourseTypesResultResType } from "@/features/course-type/types/course-type";
...
export const FilterTypes: React.FC<{ initialData: CourseTypesResultResType }> = ({ initialData }) => {
  const { data: courseTypes, error } = useSWR<CourseTypesResultResType>('course-types', fetcher, { 
