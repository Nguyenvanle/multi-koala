...
export const TeacherDetailsSection: React.FC<{ teacher: TeacherBodyType }> = ({
  ...
  const avgRating = teacher.teacherRating || 0; // Assuming avgteacherRating is in teacher object
      ...
      <CardContent className="pt-6 border-b">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col">
            <TeacherRatingItem
              initialData={{ avgteacherRating: avgRating }}
