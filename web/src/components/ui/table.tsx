  ...
  ({ className, divClassname, ...props }, ref) => (
    <div className={cn("relative w-full overflow-auto", divClassname)}>
      <table
        ref={ref}
        className={cn(
          "w-full caption-bottom text-sm font-medium text-muted-foreground",
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-gray-100 hover:dark:bg-muted/50 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
